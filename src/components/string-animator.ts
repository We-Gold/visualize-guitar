...
export const STRING_CONFIGS: Record<number, StringConfig> = {
    // String numbers follow guitar convention: 1 = high e (thinnest), 6 = low E (thickest).
    // SVG slot positions are inverted: string 6 occupies SVG "String 1" (top), string 1 uses SVG "String 6" (bottom).
    1: {
        groupId: "String 6",
        centerY: 347.04,
        startX: 234.62,
